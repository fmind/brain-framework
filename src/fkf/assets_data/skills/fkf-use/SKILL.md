...
| Inventory document | `inventories/github-repositories.json`                                             |
| Inventory record   | `inventories/github-repositories.json#fmind/fkf`                                   |
...
| Graph edge caches  | `graphs/src.tsv`, `graphs/dst.tsv`, `graphs/offsets.tsv`                           |
