...
1. Add one reviewed query under the existing `operations/queries.yaml` `queries:` list. Match the consumer's format and budget; name incorrect evidence in `forbidden_uris` when relevant.
