...
def pdf(path: Path) -> bytes:
    """Bound converter output while it runs; inherit the collector group so FKF can cancel the whole tree."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--exclude", action="append", default=[], help="base-relative glob to skip (repeatable)")
