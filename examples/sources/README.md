...
| `google-calendar.py`      | `CALENDAR START END [--agenda-days N]` | Events of one calendar; optional separate agenda snapshot spans two days before END through N days after it, with distinct agenda identities.                                   |
...
sources:
  ...
  google-calendar-events:
    ...
    refresh: 3600
  local-documents:
    command: [sources/local-documents.py, work, "{{home}}/Documents/knowledge"]
    mode: snapshot
