...
These docs describe FKF 8.2.1. Check `fkf --version` and follow the [installation guide](getting-started.md) to update an older copy. See the [changelog](https://github.com/fmind/fkf/blob/main/CHANGELOG.md) for release details.
