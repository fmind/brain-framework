...
These docs describe Brain Framework 9.0.1. Read the [changelog](https://github.com/fmind/brain-framework/blob/main/CHANGELOG.md) for release changes. Check `bf --version` and follow the [installation guide](getting-started.md) to update an older copy.
...
| Give a teammate enough context to continue | [Join a team brain](getting-started.md#join-a-team-brain) and [check its answers](getting-started.md#check-the-answers-your-team-needs). |
